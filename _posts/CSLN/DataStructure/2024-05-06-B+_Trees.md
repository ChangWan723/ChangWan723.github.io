---
title: Why Use B+ tree for Database Indexing?
...
<!-- TOC -->
  ...
  * [From Binary Search Tree to B+ Tree](#from-binary-search-tree-to-b-tree)
...
## From Binary Search Tree to B+ Tree
...
> 
> This means that a B-tree is a normal self-balancing m-way tree.
{: .prompt-tip }
